...
public class ListVariablesTest {
  ...
  public void shouldListVariablesFunction3() {
    Function function= new Multiplication(new Division(new FixedValue(9), new VarValue("x")), new VarValue("y"));
    VarManager varManager = new VarManager(function);
    final List<String> result = varManager.getVarNames();
  ...
  public void shouldListVariablesFunction4() {
    Function function= new Pwr(new Division(new FixedValue(27), new VarValue("a")), new VarValue("b"));
    VarManager varManager = new VarManager(function);
    final List<String> result = varManager.getVarNames();
  ...
  public void shouldListVariablesFunction5() {
    Function function= new Pwr(new VarValue("z"), new Division(new FixedValue(1), new FixedValue(2)));
    VarManager varManager = new VarManager(function);
    final List<String> result = varManager.getVarNames();
  ...
  public void shouldListVariablesFunction8() {
    Function function = new Multiplication(new Substraction(new FixedValue(5), new VarValue("i")), new FixedValue(8));
    VarManager variableManager = new VarManager(function);
    final List<String> result = variableManager.getVarNames();
